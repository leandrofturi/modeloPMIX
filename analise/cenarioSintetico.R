...
serieSintetica = function (parametros, dpRes, lags, n) {
  ...
  # EXCLUSAO DOS 50 PRIMEIROS
  n = n + 50
  # NUMEROS ALEATORIOS NORMALIZADOS E PADRONIZADOS MENSALMENTE
  ...
  # A SERIE SINTETICA GERADA DENTRO DE UM UNICO VETOR
  serieS = rep (0, 12*n)
...
cenarioSintetico = function (serieH, parametros, lags, n) {
  ...
  serieS = serieSintetica (parametros, dpRes, lags, (n+50))
  serieS = serieS[-(1:50), ]
